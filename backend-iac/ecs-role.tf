...
data "aws_iam_policy_document" "ecs_task_execution_policy_document" {
  ...
  # The following statements is for the situation that if you store environment variables and they will be used by ECS Task Denifition
  #   statement {
  #     actions = [
  #       "s3:GetObject"
  #     ]
  ...
  #     resources = [
  #       "arn:aws:s3:::${var.project_name}-${var.env_file_bucket_name}/*" #allow ecs to get objects from s3 bucket
  #     ]
  #   }
